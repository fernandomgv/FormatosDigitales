...
return "";
 ...
 public static string convertirInIds(string relacionados)
 {
     return relacionados.Replace("|", ";");

 }

 public static string GetImgFromTable(string tabla, int id, string columnaimg)
 {
     GeneralConnection cn = ConnectionHelper.GetConnection();
     DataSet ds = new DataSet();
     string txtquery = "Select " + columnaimg + "from " + tabla + "where " + " ItemId = " + id.ToString();
     ds = ConnectionHelper.ExecuteQuery("", null,QueryTypeEnum.SQLQuery, false);
     if (ds != null)
     {
         if (ds.Tables != null)
         {
