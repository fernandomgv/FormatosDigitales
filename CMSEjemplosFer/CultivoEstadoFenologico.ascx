...
<asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
    ...
    <Columns>
        ...
        <asp:TemplateField HeaderText="Duracion (dias)" Visible="False">
            <ItemTemplate>
        ...
        <asp:TemplateField HeaderText="Dia Inicio">
            <ItemTemplate>
                <asp:TextBox ID="DiaInicio" runat="server" AutoPostBack="False" Enabled="True" 
                    Height="22px" style="text-align:right;" Text='<%#Eval("DiaInicio")%>' 
                    Width="70px"></asp:TextBox>
            </ItemTemplate>
        </asp:TemplateField>
        <asp:TemplateField HeaderText="Dia Fin">
            <ItemTemplate>
                <asp:TextBox ID="DiaFin" runat="server" AutoPostBack="False" Enabled="True" 
                    Height="22px" style="text-align:right;" Text='<%#Eval("DiaFin")%>' 
                    Width="70px"></asp:TextBox>
            </ItemTemplate>
        </asp:TemplateField>
    </Columns>
