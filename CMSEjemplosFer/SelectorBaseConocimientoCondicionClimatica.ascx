<%@ Control Language="C#" AutoEventWireup="true" CodeFile="SelectorBaseConocimientoCondicionClimatica.ascx.cs" Inherits="CMSEjemplosFer_SelectorBaseConocimientoCondicionClimatica" %>
...
<asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
    DataKeyNames="ItemID,Checked,BaseConocimientoID,CondicionClimaticaID" 
