...
public partial class CMSEjemplosFer_SelectorCultivoPlagaEstadoFenologico : FormEngineUserControl
{
    ...
    /// </summary>
    protected void EnsureItems(int CultivoID, int PlagaID, int BaseConocimientoID)
    {
    ...
    {
        EnsureItems(this.CultivoID, this.PlagaID, this.BaseConocimientoID);
            ...
            foreach (DataRow dr in this.mtcultivoplagaestadofenologico.Rows)
            {
                ...
                {//procedemos a insertar una nueva fila
                    if (chk == 1)
                    {
                        ...
                        cultivoplagaEF.SetValue("BaseConocimientoID", this.BaseConocimientoID);
    ...
    public override object FormControlParameter
    {
        ...
        set
        {
            ...
            if (mFormControlParameter != null)
            {
                ...
                EnsureItems(this.CultivoID,ValidationHelper.GetInteger(cad,0),this.BaseConocimientoID);
