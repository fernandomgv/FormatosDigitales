...
public partial class CMSEjemplosFer_TestSuscripcionCultivo : FormEngineUserControl
{
    ...
    protected override void OnInit(EventArgs e)
    {
      ...
      //  this.Form.OnBeforeSave += new EventHandler(Form_OnBeforeSave);
