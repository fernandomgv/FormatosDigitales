...
public partial class CMSModules_CustomTables_Controls_CustomTableDataList : CMSUserControl
{
    ...
    {
        if ((this.CustomTableClassInfo.ClassName == "customtable.SPATS_Cultivo") | (this.CustomTableClassInfo.ClassName == "customtable.SPATS_Plaga") | (this.CustomTableClassInfo.ClassName == "customtable.Condicion_Climatica") | (this.CustomTableClassInfo.ClassName == "customtable.Base_Conocimiento") | (this.CustomTableClassInfo.ClassName == "customtable.Base_Hechos_Lecturas"))
        {
        var territorio = QueryHelper.GetInteger("territorio", 0);
        if (territorio>0)
        {
            gridData.WhereClause="bc.territorioId="+territorio;
        }
        }
    }
