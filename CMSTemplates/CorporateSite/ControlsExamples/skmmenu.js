...
/*		if (skm_previousMenu != null) {
			skm_previousMenu.className = "CMSMenu";
		}
		skm_previousMenu = document.getElementById(childID);
		skm_previousMenu.className = "CMSMenuActive";		*/
		...
		if (displayedVertically){ // Set the child menu's left and top attributes according to the menu's offsets
			...
			//document.getElementById(childID).style.backgroundColor='green';			
			...
			if ( (parseInt(skm_getElementLeft(document.getElementById(childID)),10) + parseInt(document.getElementById(childID).offsetWidth,10))>visibleWidth) {				
				...
				//alert(newpos + '=' + oldpos + '-' + parent.offsetWidth + ' - ' + width);
...
function skm_mousedOutMenu(menuID,elem,imageSource,cssClass){
